...
public class MainController extends HttpServlet {
    ...
    private static final String WELLCOME="login.html";
    ...
    private static final String SHOPING_PAGE_VIEW="ViewProductController";
    ...
    private static final String CHECKOUT_PRODUCT="CheckoutProduct";
    private static final String CHECKOUT_PRODUCT_CONTROLLER="CheckoutController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            } else if (CHECKOUT_PRODUCT.equals(action)) {
                url = CHECKOUT_PRODUCT_CONTROLLER;
